...
#define LED_CONTROL_CY_TCPWM_4000                  (CY_PSOC4_4000)
...
#define LED_CONTROL_QUAD_AUTO_START                (0lu)
...
/* PWM Mode */
#define LED_CONTROL_PWM_PERIOD_VALUE               (48000lu)
...
#define LED_CONTROL_PWM_MODE_ASYM                  (LED_CONTROL_CC_MATCH_INVERT       |   \
                                                         LED_CONTROL_OVERLOW_SET           |   \
                                                         LED_CONTROL_UNDERFLOW_CLEAR)

#if (LED_CONTROL_CY_TCPWM_V2)
    #if(LED_CONTROL_CY_TCPWM_4000)
        ...
        #define LED_CONTROL_PWM_MODE_CENTER                (LED_CONTROL_CC_MATCH_INVERT       |   \
                                                                 LED_CONTROL_OVERLOW_SET           |   \
                                                                 LED_CONTROL_UNDERFLOW_CLEAR)
    #endif /* (LED_CONTROL_CY_TCPWM_4000) */
#else
    #define LED_CONTROL_PWM_MODE_CENTER                (LED_CONTROL_CC_MATCH_INVERT       |   \
                                                             LED_CONTROL_OVERLOW_NO_CHANGE     |   \
                                                             LED_CONTROL_UNDERFLOW_CLEAR)
#endif /* (LED_CONTROL_CY_TCPWM_NEW) */
...
#define LED_CONTROL_QUAD_SIGNALS_MODES                                                             \
...
#define LED_CONTROL_PWM_SIGNALS_MODES                                                              \
...
#define LED_CONTROL_TIMER_SIGNALS_MODES                                                            \
...
#define LED_CONTROL_TIMER_UPDOWN_CNT_USED                                                          \
                ((LED_CONTROL__COUNT_UPDOWN0 == LED_CONTROL_TC_COUNTER_MODE)                  ||\
                 (LED_CONTROL__COUNT_UPDOWN1 == LED_CONTROL_TC_COUNTER_MODE))

#define LED_CONTROL_PWM_UPDOWN_CNT_USED                                                            \
                ((LED_CONTROL__CENTER == LED_CONTROL_PWM_ALIGN)                               ||\
                 (LED_CONTROL__ASYMMETRIC == LED_CONTROL_PWM_ALIGN))               
        
#define LED_CONTROL_PWM_PR_INIT_VALUE              (1u)
#define LED_CONTROL_QUAD_PERIOD_INIT_VALUE         (0x8000u)
