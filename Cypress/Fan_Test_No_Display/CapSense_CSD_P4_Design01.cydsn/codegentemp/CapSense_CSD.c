...
reg32 * CapSense_CSD_pcTable[] = {
    ...
    (reg32 *)CapSense_CSD_Sns__LinearSlider0_e1__LS__PC, 
    (reg32 *)CapSense_CSD_Sns__LinearSlider0_e2__LS__PC, 
    (reg32 *)CapSense_CSD_Sns__LinearSlider0_e3__LS__PC, 
    (reg32 *)CapSense_CSD_Sns__LinearSlider0_e4__LS__PC, 
};

const uint8 CapSense_CSD_portTable[] = {
    CapSense_CSD_Sns__LinearSlider0_e0__LS__PORT, 
    CapSense_CSD_Sns__LinearSlider0_e1__LS__PORT, 
    CapSense_CSD_Sns__LinearSlider0_e2__LS__PORT, 
    CapSense_CSD_Sns__LinearSlider0_e3__LS__PORT, 
    CapSense_CSD_Sns__LinearSlider0_e4__LS__PORT, 
};

const uint32 CapSense_CSD_maskTable[] = {
    CapSense_CSD_Sns__LinearSlider0_e0__LS__MASK, 
    CapSense_CSD_Sns__LinearSlider0_e1__LS__MASK, 
    CapSense_CSD_Sns__LinearSlider0_e2__LS__MASK, 
    CapSense_CSD_Sns__LinearSlider0_e3__LS__MASK, 
    CapSense_CSD_Sns__LinearSlider0_e4__LS__MASK, 
};

const uint8 CapSense_CSD_pinShiftTbl[] = {
    (uint8) CapSense_CSD_Sns__LinearSlider0_e0__LS__SHIFT, 
    (uint8) CapSense_CSD_Sns__LinearSlider0_e1__LS__SHIFT, 
    (uint8) CapSense_CSD_Sns__LinearSlider0_e2__LS__SHIFT, 
    (uint8) CapSense_CSD_Sns__LinearSlider0_e3__LS__SHIFT, 
    (uint8) CapSense_CSD_Sns__LinearSlider0_e4__LS__SHIFT, 
};
