...
#define CY_BLE_CONFIG_L2CAP_ENABLE                  (0u)
...
#define CY_BLE_CAPSENSE_SLIDER_SERVICE_HANDLE   (0x000Cu) /* Handle of CapSense Slider service */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_DECL_HANDLE   (0x000Du) /* Handle of CapSense Slider characteristic declaration */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_CHAR_HANDLE   (0x000Eu) /* Handle of CapSense Slider characteristic */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_CAPSENSE_SLIDER_CAPSENSE_SLIDER_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_RGB_LED_SERVICE_HANDLE   (0x0011u) /* Handle of RGB LED service */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_DECL_HANDLE   (0x0012u) /* Handle of RGB LED Control characteristic declaration */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_CHAR_HANDLE   (0x0013u) /* Handle of RGB LED Control characteristic */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0014u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_RGB_LED_RGB_LED_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0015u) /* Handle of Characteristic User Description descriptor */

#define CY_BLE_CAPSENSE_BUTTON_SERVICE_HANDLE   (0x0016u) /* Handle of CapSense Button service */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_DECL_HANDLE   (0x0017u) /* Handle of CapSense Button characteristic declaration */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_CHAR_HANDLE   (0x0018u) /* Handle of CapSense Button characteristic */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0019u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_CAPSENSE_BUTTON_CAPSENSE_BUTTON_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Au) /* Handle of Characteristic User Description descriptor */
