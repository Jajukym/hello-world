...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\bryan.lee\Documents\PSoC Creator\Pulse_psoc5\Combine\Combine.cydsn\Combine.svd" rem "C:\Users\bryan.lee\Documents\PSoC Creator\Pulse_psoc5\Combine\Combine.cydsn\Combine.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
