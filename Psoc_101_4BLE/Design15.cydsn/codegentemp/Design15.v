// ======================================================================
// Design15.v generated from TopDesign.cysch
// 01/10/2019 at 09:49
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_25 or Net_26 or Net_31)
        begin
            case (Net_31)
                1'b0 :  tmp__mux_1_reg = Net_25;
                1'b1 :  tmp__mux_1_reg = Net_26;
            endcase
        end
        assign Net_32 = tmp__mux_1_reg;
    end
    // -- Mux end --
