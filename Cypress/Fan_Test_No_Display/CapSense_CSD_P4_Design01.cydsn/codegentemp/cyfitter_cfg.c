...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL4, 0x00000200u);
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL8), 0x00000043u);
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL6), 0x00000044u);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0xEE330800u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00003333u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL3), 0x33830000u);

		/* UDB_PA_0 Starting address: CYDEV_UDB_PA0_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA0_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0xA1000000u);

		/* UDB_PA_1 Starting address: CYDEV_UDB_PA1_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA1_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x004E0000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG8), 0x4E000000u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00DB6180u);
