// ======================================================================
// CE220331_BLE_UI_RTOS.v generated from TopDesign.cysch
// 11/07/2019 at 16:03
...
module top ;
    ...
    SCB_SPI_PDL_v2_0_3 CY_EINK_SPIM (
        .interrupt(Net_259),
        .clock(1'b0),
        .rx_dma(Net_261),
        .tx_dma(Net_262),
    ...
    defparam R.comp_name = "LED_v1_0";
    defparam R.port_names = "A, K";
    defparam R.width = 2;

    CapSense_v2_0_4 CapSense ();


	cy_clock_v1_0
		#(.id("2c7bbf56-5a76-4250-97de-827cfda67a8c"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpFB_0__Pin_RGB_Blue_net;
	wire [0:0] tmpIO_0__Pin_RGB_Blue_net;
	electrical [0:0] tmpSIOVREF__Pin_RGB_Blue_net;

	cy_mxs40_gpio_v1_0
		#(.id("a45c91c4-b511-493a-a6d5-32ffc241a43a"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		Pin_RGB_Blue
		 (.oe({1'b1}),
		  .y({Net_374}),
		  .fb({tmpFB_0__Pin_RGB_Blue_net[0:0]}),
		  .io({tmpIO_0__Pin_RGB_Blue_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_RGB_Blue_net),
		  .annotation({Net_1247}));
    ...
    TCPWM_PWM_PDL_v1_0_6 PWM_Green (
        .kill(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpFB_0__Pin_RGB_Red_net;
	wire [0:0] tmpIO_0__Pin_RGB_Red_net;
	electrical [0:0] tmpSIOVREF__Pin_RGB_Red_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_RGB_Red
		 (.oe({1'b1}),
		  .y({Net_200}),
		  .fb({tmpFB_0__Pin_RGB_Red_net[0:0]}),
		  .io({tmpIO_0__Pin_RGB_Red_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_RGB_Red_net),
		  .annotation({Net_1213}));


	wire [0:0] tmpFB_0__Pin_RGB_Green_net;
	wire [0:0] tmpIO_0__Pin_RGB_Green_net;
	electrical [0:0] tmpSIOVREF__Pin_RGB_Green_net;
	...
	cy_mxs40_gpio_v1_0
		...
		Pin_RGB_Green
		 (.oe({1'b1}),
		  .y({Net_232}),
		  .fb({tmpFB_0__Pin_RGB_Green_net[0:0]}),
		  .io({tmpIO_0__Pin_RGB_Green_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_RGB_Green_net),
		  .annotation({Net_1235}));


    Scan_ADC_v2_10_7 ADC (
        .sdone(Net_1920),
        .eos(Net_1921),
        .t_chidv(Net_1922),
        .t_chid(Net_2578[3:0]),
    ...
    cy_annotation_universal_v1_0 B (
        .connect({
            Net_925,
            Net_1248
        })
    );
    defparam B.comp_name = "LED_v1_0";
    defparam B.port_names = "A, K";
    defparam B.width = 2;

    cy_annotation_universal_v1_0 G (
        .connect({
            Net_925,
            Net_1236
        })
    );
    defparam G.comp_name = "LED_v1_0";
    defparam G.port_names = "A, K";
    defparam G.width = 2;
