...
*/
     ...
     */
        /* Drive Modes */
        #define pinUp_DM_ALG_HIZ         PIN_DM_ALG_HIZ   /**< \brief High Impedance Analog   */
        #define pinUp_DM_DIG_HIZ         PIN_DM_DIG_HIZ   /**< \brief High Impedance Digital  */
        #define pinUp_DM_RES_UP          PIN_DM_RES_UP    /**< \brief Resistive Pull Up       */
        #define pinUp_DM_RES_DWN         PIN_DM_RES_DWN   /**< \brief Resistive Pull Down     */
        #define pinUp_DM_OD_LO           PIN_DM_OD_LO     /**< \brief Open Drain, Drives Low  */
        #define pinUp_DM_OD_HI           PIN_DM_OD_HI     /**< \brief Open Drain, Drives High */
        #define pinUp_DM_STRONG          PIN_DM_STRONG    /**< \brief Strong Drive            */
        #define pinUp_DM_RES_UPDWN       PIN_DM_RES_UPDWN /**< \brief Resistive Pull Up/Down  */
    /** @} driveMode */
/** @} group_constants */
...
*/
     ...
     */
        ...
        #define pinUp_INTR_RISING    (uint16)(0x0001u)   /**< \brief Rising edge trigger  */
        #define pinUp_INTR_FALLING   (uint16)(0x0002u)   /**< \brief Falling edge trigger */
        #define pinUp_INTR_BOTH      (uint16)(0x0003u)   /**< \brief Both edge trigger    */
        /** @} intrMode */
/** @} group_constants */

    #define pinUp_INTR_MASK      (0x01u)
#endif /* (pinUp__INTSTAT) */
...
/* SIO registers */
#if defined(pinUp__SIO_CFG)
    #define pinUp_SIO_HYST_EN        (* (reg8 *) pinUp__SIO_HYST_EN)
    #define pinUp_SIO_REG_HIFREQ     (* (reg8 *) pinUp__SIO_REG_HIFREQ)
    #define pinUp_SIO_CFG            (* (reg8 *) pinUp__SIO_CFG)
    #define pinUp_SIO_DIFF           (* (reg8 *) pinUp__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define pinUp_0_INTTYPE_REG 		(* (reg8 *) pinUp__0__INTTYPE)
#endif /* (pinUp__INTSTAT) */
