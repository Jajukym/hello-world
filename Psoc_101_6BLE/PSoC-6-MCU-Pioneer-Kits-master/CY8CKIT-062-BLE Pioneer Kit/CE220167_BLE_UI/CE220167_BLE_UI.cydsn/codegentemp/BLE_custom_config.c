...
static const cy_stc_ble_customs_t cy_ble_customs[0x03u] = {
    ...
    {
        0x000Cu, /* Handle of the CapSense Slider service */ 
        {

            /* CapSense Slider characteristic */
            {
                0x000Eu, /* Handle of the CapSense Slider characteristic */ 
    ...
    /* RGB LED service */
    {
        0x0011u, /* Handle of the RGB LED service */ 
        {

            /* RGB LED Control characteristic */
            {
                0x0013u, /* Handle of the RGB LED Control characteristic */ 
    ...
    {
        0x0016u, /* Handle of the CapSense Button service */ 
        {

            /* CapSense Button characteristic */
            {
                0x0018u, /* Handle of the CapSense Button characteristic */ 
