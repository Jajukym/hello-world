// ======================================================================
// Legacy_Program_Test.v generated from TopDesign.cysch
// 11/17/2017 at 16:51
...
// CharLCDmp_v1_00(ConversionRoutines=true, CUSTOM0="10,8,4,2,1,0,0,0,", CUSTOM1="4,4,4,4,4,0,0,0,", CUSTOM2="1,2,4,8,10,0,0,0,", CUSTOM3="0,0,1F,0,0,0,0,0,", CUSTOM4="0,0,0,0,0,4,E,4,", CUSTOM5="0,0,0,0,0,0,0,0,", CUSTOM6="0,0,0,0,0,0,0,0,", CUSTOM7="0,0,0,0,0,0,0,0,", CustomCharacterSet=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=CharLCDmp_v1_00, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=LCD, )
...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_40_1 ADC_SAR_Seq_Button (
        .Vref(Net_1876),
        .sdone(Net_1877),
        .eoc(Net_1878),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__pinPower_net;
	wire [0:0] tmpFB_0__pinPower_net;
	wire [0:0] tmpIO_0__pinPower_net;
	wire [0:0] tmpINTERRUPT_0__pinPower_net;
	electrical [0:0] tmpSIOVREF__pinPower_net;

	cy_psoc3_pins_v1_10
		#(.id("c2ce6401-7d18-4717-9f94-1f560526aa33"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pinPower
		 (.oe(tmpOE__pinPower_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pinPower_net[0:0]}),
		  .io({tmpIO_0__pinPower_net[0:0]}),
		  .siovref(tmpSIOVREF__pinPower_net),
		  .interrupt({tmpINTERRUPT_0__pinPower_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinPower_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinReset_net;
	wire [0:0] tmpFB_0__pinReset_net;
	wire [0:0] tmpIO_0__pinReset_net;
	wire [0:0] tmpINTERRUPT_0__pinReset_net;
	electrical [0:0] tmpSIOVREF__pinReset_net;

	cy_psoc3_pins_v1_10
		#(.id("7b28ccf3-7a80-4ac5-b0da-d43ee1196afc"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pinReset
		 (.oe(tmpOE__pinReset_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pinReset_net[0:0]}),
		  .io({tmpIO_0__pinReset_net[0:0]}),
		  .siovref(tmpSIOVREF__pinReset_net),
		  .interrupt({tmpINTERRUPT_0__pinReset_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinReset_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
