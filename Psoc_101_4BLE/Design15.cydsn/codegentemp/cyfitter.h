...
#define Control_Sync_ctrl_reg__CONTROL_AUX_CTL_REG CYREG_UDB_W8_ACTL3
#define Control_Sync_ctrl_reg__CONTROL_REG CYREG_UDB_W8_CTL3
#define Control_Sync_ctrl_reg__CONTROL_ST_REG CYREG_UDB_CAT16_CTL_ST3
#define Control_Sync_ctrl_reg__COUNT_REG CYREG_UDB_W8_CTL3
#define Control_Sync_ctrl_reg__COUNT_ST_REG CYREG_UDB_CAT16_CTL_ST3
#define Control_Sync_ctrl_reg__MASK 0x01u
#define Control_Sync_ctrl_reg__MASK_CTL_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK3
#define Control_Sync_ctrl_reg__PER_CTL_AUX_CTL_REG CYREG_UDB_CAT16_ACTL_MSK3
#define Control_Sync_ctrl_reg__PERIOD_REG CYREG_UDB_W8_MSK3
...
/* Miscellaneous */
#define CY_PROJECT_NAME "Design15"
