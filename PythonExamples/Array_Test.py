header = ['RecordID', 'Link to Parts - Consoles', 'Link to Parts - Console Pics', 'Part Number','Description',
          'ProductType', 'Display Type', 'Equipment Needed', 'Setup', 'BLE SETUP', 'Part Type Pull', 'PIP',
          'Video of Inspection', 'EQF1259 Config', 'BLE Setup Image 1', 'Setup Image 2', 'Setup Image 1',
          'Setup Image 2', 'ESD Bag', 'Cosmetics', 'Warning Label', 'Warning Label Picture',
          ...
          'Created By User', 'Updated', 'Created'];
