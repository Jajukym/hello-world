// ======================================================================
// SAR_SPIM_USB.v generated from TopDesign.cysch
// 04/02/2020 at 10:49
...
// IDAC8_v2_0(Current=10, Data_Source=0, Hardware_Enable=false, IDAC_Range=0, IDAC_Speed=0, Initial_Value=80, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONFIG_TITLE=IDAC8, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC8, CY_INSTANCE_SHORT_NAME=IDAC8, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=IDAC8, )
module IDAC8_v2_0_0 (
    strobe,
    data,
    iOut,
...
module CharLCD_v2_20_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("da95f9af-420f-44b6-9152-7414d9acd701/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1800000, ADC_Input_Range=4, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=5, Ref_Voltage_mV=5000, rm_int=false, Sample_Precharge=6, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_SAR_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_0, CY_INSTANCE_SHORT_NAME=ADC_SAR_0, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=ADC_SAR_0, )
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d94a0ac-9f29-4097-842a-dd84916ec16f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Mux0_0_net;
	wire [0:0] tmpFB_0__Mux0_0_net;
	wire [0:0] tmpIO_0__Mux0_0_net;
	wire [0:0] tmpINTERRUPT_0__Mux0_0_net;
	electrical [0:0] tmpSIOVREF__Mux0_0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cc3bcd7e-5dc0-48ea-9bf6-6aa082be1ada"),
		  ...
		  .input_buffer_sel(2'b00))
		Mux0_0
		 (.oe(tmpOE__Mux0_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux0_0_net[0:0]}),
		  .analog({Net_411}),
		  .io({tmpIO_0__Mux0_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux0_0_net),
		  .interrupt({tmpINTERRUPT_0__Mux0_0_net[0:0]}),
		  .annotation({Net_314}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux0_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux0_1_net;
	wire [0:0] tmpFB_0__Mux0_1_net;
	wire [0:0] tmpIO_0__Mux0_1_net;
	wire [0:0] tmpINTERRUPT_0__Mux0_1_net;
	electrical [0:0] tmpSIOVREF__Mux0_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9127e74f-f689-4cfe-acd8-a210e7261f25"),
		  ...
		  .input_buffer_sel(2'b00))
		Mux0_1
		 (.oe(tmpOE__Mux0_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux0_1_net[0:0]}),
		  .analog({Net_410}),
		  .io({tmpIO_0__Mux0_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux0_1_net),
		  .interrupt({tmpINTERRUPT_0__Mux0_1_net[0:0]}),
		  .annotation({Net_112}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux0_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux0_2_net;
	wire [0:0] tmpFB_0__Mux0_2_net;
	wire [0:0] tmpIO_0__Mux0_2_net;
	wire [0:0] tmpINTERRUPT_0__Mux0_2_net;
	electrical [0:0] tmpSIOVREF__Mux0_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d0aeae95-3459-46d2-a0c1-198562668364"),
		  ...
		  .input_buffer_sel(2'b00))
		Mux0_2
		 (.oe(tmpOE__Mux0_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux0_2_net[0:0]}),
		  .analog({Net_409}),
		  .io({tmpIO_0__Mux0_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux0_2_net),
		  .interrupt({tmpINTERRUPT_0__Mux0_2_net[0:0]}),
		  .annotation({Net_183}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux0_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux0_3_net;
	wire [0:0] tmpFB_0__Mux0_3_net;
	wire [0:0] tmpIO_0__Mux0_3_net;
	wire [0:0] tmpINTERRUPT_0__Mux0_3_net;
	electrical [0:0] tmpSIOVREF__Mux0_3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8eb8586e-72e7-4fbb-93f5-34ce0d422961"),
		  ...
		  .input_buffer_sel(2'b00))
		Mux0_3
		 (.oe(tmpOE__Mux0_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux0_3_net[0:0]}),
		  .analog({Net_408}),
		  .io({tmpIO_0__Mux0_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux0_3_net),
		  .interrupt({tmpINTERRUPT_0__Mux0_3_net[0:0]}),
		  .annotation({Net_80}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux0_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux1_0_net;
	wire [0:0] tmpFB_0__Mux1_0_net;
	wire [0:0] tmpIO_0__Mux1_0_net;
	wire [0:0] tmpINTERRUPT_0__Mux1_0_net;
	electrical [0:0] tmpSIOVREF__Mux1_0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("7643af0b-baad-463d-88c5-766b38067da5"),
		  ...
		  .input_buffer_sel(2'b00))
		Mux1_0
		 (.oe(tmpOE__Mux1_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux1_0_net[0:0]}),
		  .analog({Net_407}),
		  .io({tmpIO_0__Mux1_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux1_0_net),
		  .interrupt({tmpINTERRUPT_0__Mux1_0_net[0:0]}),
		  .annotation({Net_86}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux1_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux1_1_net;
	wire [0:0] tmpFB_0__Mux1_1_net;
	wire [0:0] tmpIO_0__Mux1_1_net;
	wire [0:0] tmpINTERRUPT_0__Mux1_1_net;
	electrical [0:0] tmpSIOVREF__Mux1_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c5d28206-6e73-4298-9fc9-4b55c4d6cbf9"),
		  ...
		  .input_buffer_sel(2'b00))
		Mux1_1
		 (.oe(tmpOE__Mux1_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux1_1_net[0:0]}),
		  .analog({Net_406}),
		  .io({tmpIO_0__Mux1_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux1_1_net),
		  .interrupt({tmpINTERRUPT_0__Mux1_1_net[0:0]}),
		  .annotation({Net_127}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux1_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux1_2_net;
	wire [0:0] tmpFB_0__Mux1_2_net;
	wire [0:0] tmpIO_0__Mux1_2_net;
	wire [0:0] tmpINTERRUPT_0__Mux1_2_net;
	electrical [0:0] tmpSIOVREF__Mux1_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3badf285-82a2-44d2-b906-37c8fc077746"),
		  ...
		  .input_buffer_sel(2'b00))
		Mux1_2
		 (.oe(tmpOE__Mux1_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux1_2_net[0:0]}),
		  .analog({Net_405}),
		  .io({tmpIO_0__Mux1_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux1_2_net),
		  .interrupt({tmpINTERRUPT_0__Mux1_2_net[0:0]}),
		  .annotation({Net_87}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux1_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mux1_3_net;
	wire [0:0] tmpFB_0__Mux1_3_net;
	wire [0:0] tmpIO_0__Mux1_3_net;
	wire [0:0] tmpINTERRUPT_0__Mux1_3_net;
	electrical [0:0] tmpSIOVREF__Mux1_3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3eacd475-d8ec-4841-ad8b-2e84949c6299"),
		  ...
		  .input_buffer_sel(2'b00))
		Mux1_3
		 (.oe(tmpOE__Mux1_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mux1_3_net[0:0]}),
		  .analog({Net_404}),
		  .io({tmpIO_0__Mux1_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Mux1_3_net),
		  .interrupt({tmpINTERRUPT_0__Mux1_3_net[0:0]}),
		  .annotation({Net_126}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Mux1_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    SPI_Master_v2_50_2 SPIM (
        ...
        .clock(Net_340),
        .reset(Net_308),
        .rx_interrupt(Net_309),
        .sdat(Net_310),
        .tx_interrupt(Net_311));
    ...
    CharLCD_v2_20_4 LCD_Char ();

    ADC_SAR_v3_10_5 ADC_SAR_0 (
        .vplus(Net_17),
        .vminus(Net_131),
        .soc(Net_399),
        .eoc(Net_400),
    ...
    cy_psoc3_amux_v1_0 AMux_0_CYAMUXSIDE_A(
        .muxin({
            Net_408,
            Net_409,
            Net_410,
    ...
    defparam AMux_0_CYAMUXSIDE_A.muxin_width = 4;
    defparam AMux_0_CYAMUXSIDE_A.init_mux_sel = 4'h0;
    defparam AMux_0_CYAMUXSIDE_A.one_active = 0;
    defparam AMux_0_CYAMUXSIDE_A.connect_mode = 1;
    
    
    // -- Mux B --
    
    cy_psoc3_amux_v1_0 AMux_0_CYAMUXSIDE_B(
        .muxin({
            Net_368,
            Net_368,
            Net_368,
    ...
    defparam AMux_0_CYAMUXSIDE_B.muxin_width = 4;
    defparam AMux_0_CYAMUXSIDE_B.init_mux_sel = 4'h0;
    defparam AMux_0_CYAMUXSIDE_B.one_active = 0;
    defparam AMux_0_CYAMUXSIDE_B.connect_mode = 1;
