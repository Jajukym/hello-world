// ======================================================================
// PowerSupply test.v generated from TopDesign.cysch
// 02/14/2021 at 09:51
...
// CharLCDmp_v1_00(ConversionRoutines=true, CUSTOM0=0,E,8,8,8,E,0, CUSTOM1=0,A,A,4,4,4,0, CUSTOM2=0,E,A,E,8,8,0, CUSTOM3=0,E,A,C,A,A,0, CUSTOM4=0,E,8,C,8,E,0, CUSTOM5=0,E,8,E,2,E,0, CUSTOM6=0,E,8,E,2,E,0, CUSTOM7=0,4,4,4,0,4,0, CustomCharacterSet=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=CharLCDmp_v1_00, CY_CONFIG_TITLE=LCD, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=LCD, )
module CharLCDmp_v1_00_0 (
    DB4,
    DB5,
    DB6,
    DB7,
...
module top ;
	...
	wire [0:0] tmpOE__pinRelay_net;
	wire [0:0] tmpFB_0__pinRelay_net;
	wire [0:0] tmpIO_0__pinRelay_net;
	wire [0:0] tmpINTERRUPT_0__pinRelay_net;
	electrical [0:0] tmpSIOVREF__pinRelay_net;
	...
	cy_psoc3_pins_v1_10
		...
		pinRelay
		 (.oe(tmpOE__pinRelay_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pinRelay_net[0:0]}),
		  .io({tmpIO_0__pinRelay_net[0:0]}),
		  .siovref(tmpSIOVREF__pinRelay_net),
		  .interrupt({tmpINTERRUPT_0__pinRelay_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinRelay_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinSwitchIndicator_net;
	wire [0:0] tmpFB_0__pinSwitchIndicator_net;
	wire [0:0] tmpIO_0__pinSwitchIndicator_net;
	wire [0:0] tmpINTERRUPT_0__pinSwitchIndicator_net;
	electrical [0:0] tmpSIOVREF__pinSwitchIndicator_net;

	cy_psoc3_pins_v1_10
		#(.id("1ef15f50-0b44-4a9c-b43f-05f823f9cca3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pinSwitchIndicator
		 (.oe(tmpOE__pinSwitchIndicator_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pinSwitchIndicator_net[0:0]}),
		  .io({tmpIO_0__pinSwitchIndicator_net[0:0]}),
		  .siovref(tmpSIOVREF__pinSwitchIndicator_net),
		  .interrupt({tmpINTERRUPT_0__pinSwitchIndicator_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinSwitchIndicator_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CharLCDmp_v1_00_0 LCD (
        .DB4(Net_25),
        .DB5(Net_26),
        .DB6(Net_27),
        .DB7(Net_28),
	...
	cy_psoc3_pins_v1_10
		#(.id("e73ca10f-7398-402f-9432-c8b87a7bad0e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    ADC_SAR_SEQ_P4_v2_40_2 ADC_SAR_Seq_Button (
        .aclk(1'b0),
        .eoc(Net_71),
        .sdone(Net_72),
        .soc(1'b0),
