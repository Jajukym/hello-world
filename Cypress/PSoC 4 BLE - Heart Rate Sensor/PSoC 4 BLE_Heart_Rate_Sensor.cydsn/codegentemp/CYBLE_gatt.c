    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x36u] = {
    /* Device Name */
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0002u, (void *)&cyBle_attValues[31] }, /* Heart Rate Measurement */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0001u, (void *)&cyBle_attValues[33] }, /* Body Sensor Location */
    { 0x0001u, (void *)&cyBle_attValues[34] }, /* Heart Rate Control Point */
    { 0x0004u, (void *)&cyBle_attValues[35] }, /* Manufacturer Name String */
    { 0x0000u, (void *)&cyBle_attValues[39] }, /* Model Number String */
    { 0x0000u, (void *)&cyBle_attValues[39] }, /* Serial Number String */
    { 0x0000u, (void *)&cyBle_attValues[39] }, /* Hardware Revision String */
    { 0x0000u, (void *)&cyBle_attValues[39] }, /* Firmware Revision String */
    { 0x0000u, (void *)&cyBle_attValues[39] }, /* Software Revision String */
    { 0x0008u, (void *)&cyBle_attValues[39] }, /* System ID */
    { 0x0000u, (void *)&cyBle_attValues[47] }, /* IEEE 11073-20601 Regulatory Certification Data List */
    { 0x0007u, (void *)&cyBle_attValues[47] }, /* PnP ID */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x26u] = {
    ...
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf    */, 0x000Fu, {{0x2A37u, NULL}}                           },
    { 0x000Eu, 0x2A37u /* Heart Rate Measurement              */, 0x01100000u /* ntf    */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x0010u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0011u, {{0x2A38u, NULL}}                           },
    { 0x0011u, 0x2A38u /* Body Sensor Location                */, 0x01020001u /* rd     */, 0x0011u, {{0x0001u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0012u, 0x2803u /* Characteristic                      */, 0x00080001u /* wr     */, 0x0013u, {{0x2A39u, NULL}}                           },
    { 0x0013u, 0x2A39u /* Heart Rate Control Point            */, 0x01080100u /* wr     */, 0x0013u, {{0x0001u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0014u, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x0026u, {{0x180Au, NULL}}                           },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0016u, {{0x2A29u, NULL}}                           },
    { 0x0016u, 0x2A29u /* Manufacturer Name String            */, 0x01020001u /* rd     */, 0x0016u, {{0x0004u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0017u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0018u, {{0x2A24u, NULL}}                           },
    { 0x0018u, 0x2A24u /* Model Number String                 */, 0x01020001u /* rd     */, 0x0018u, {{0x0000u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0019u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x001Au, {{0x2A25u, NULL}}                           },
    { 0x001Au, 0x2A25u /* Serial Number String                */, 0x01020001u /* rd     */, 0x001Au, {{0x0000u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x001Bu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x001Cu, {{0x2A27u, NULL}}                           },
    { 0x001Cu, 0x2A27u /* Hardware Revision String            */, 0x01020001u /* rd     */, 0x001Cu, {{0x0000u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x001Du, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x001Eu, {{0x2A26u, NULL}}                           },
    { 0x001Eu, 0x2A26u /* Firmware Revision String            */, 0x01020001u /* rd     */, 0x001Eu, {{0x0000u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x001Fu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0020u, {{0x2A28u, NULL}}                           },
    { 0x0020u, 0x2A28u /* Software Revision String            */, 0x01020001u /* rd     */, 0x0020u, {{0x0000u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0021u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0022u, {{0x2A23u, NULL}}                           },
    { 0x0022u, 0x2A23u /* System ID                           */, 0x01020001u /* rd     */, 0x0022u, {{0x0008u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0023u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0024u, {{0x2A2Au, NULL}}                           },
    { 0x0024u, 0x2A2Au /* IEEE 11073-20601 Regulatory Certifi */, 0x01020001u /* rd     */, 0x0024u, {{0x0000u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0025u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd     */, 0x0026u, {{0x2A50u, NULL}}                           },
    { 0x0026u, 0x2A50u /* PnP ID                              */, 0x01020001u /* rd     */, 0x0026u, {{0x0007u, (void *)&cyBle_attValuesLen[17]}} },
};
