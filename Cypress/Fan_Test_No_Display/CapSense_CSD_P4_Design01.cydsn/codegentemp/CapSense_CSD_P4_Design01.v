// ======================================================================
// CapSense_CSD_P4_Design01.v generated from TopDesign.cysch
// 09/27/2019 at 08:33
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=14, Polarity=1, Resolution=7, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDAC2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense_CSD:IDAC2, CY_INSTANCE_SHORT_NAME=IDAC2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=CapSense_CSD_IDAC2, )
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=16, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDAC1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense_CSD:IDAC1, CY_INSTANCE_SHORT_NAME=IDAC1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=CapSense_CSD_IDAC1, )
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=1, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=0, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=48000, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=LED_CONTROL_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LED_CONTROL_1, CY_INSTANCE_SHORT_NAME=LED_CONTROL_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=LED_CONTROL_1, )
...
// CharLCDmp_v1_00(ConversionRoutines=true, CUSTOM0=0,E,8,8,8,E,0, CUSTOM1=0,A,A,4,4,4,0, CUSTOM2=0,E,A,E,8,8,0, CUSTOM3=0,E,A,C,A,A,0, CUSTOM4=0,E,8,C,8,E,0, CUSTOM5=0,E,8,E,2,E,0, CUSTOM6=0,E,8,E,2,E,0, CUSTOM7=0,4,4,4,0,4,0, CustomCharacterSet=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=CharLCDmp_v1_00, CY_CONFIG_TITLE=LCD, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=LCD, )
module CharLCDmp_v1_00_5 (
    RS,
    E,
    DB4,
    DB5,
...
module top ;
	...
	wire [0:0] tmpOE__Pin_PWM_Out_net;
	wire [0:0] tmpFB_0__Pin_PWM_Out_net;
	wire [0:0] tmpIO_0__Pin_PWM_Out_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PWM_Out_net;
	electrical [0:0] tmpSIOVREF__Pin_PWM_Out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PWM_Out
		 (.oe(tmpOE__Pin_PWM_Out_net),
		  .y({Net_331}),
		  .fb({tmpFB_0__Pin_PWM_Out_net[0:0]}),
		  .io({tmpIO_0__Pin_PWM_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PWM_Out_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PWM_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PWM_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_4 LED_CONTROL_1 (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_psoc3_pins_v1_10
		#(.id("34e9617c-840a-4e66-853b-e1bb82dc49d5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_PWM_Out_1_net;
	wire [0:0] tmpFB_0__Pin_PWM_Out_1_net;
	wire [0:0] tmpIO_0__Pin_PWM_Out_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PWM_Out_1_net;
	electrical [0:0] tmpSIOVREF__Pin_PWM_Out_1_net;

	cy_psoc3_pins_v1_10
		#(.id("aa7700cd-8815-4332-b0a5-c2270906553e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PWM_Out_1
		 (.oe(tmpOE__Pin_PWM_Out_1_net),
		  .y({Net_360}),
		  .fb({tmpFB_0__Pin_PWM_Out_1_net[0:0]}),
		  .io({tmpIO_0__Pin_PWM_Out_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PWM_Out_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PWM_Out_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PWM_Out_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CharLCDmp_v1_00_5 LCD (
        .RS(Net_576),
        .E(Net_577),
        .DB4(Net_578),
        .DB5(Net_579),
	...
	wire [0:0] tmpOE__pinRS_net;
	wire [0:0] tmpFB_0__pinRS_net;
	wire [0:0] tmpIO_0__pinRS_net;
	wire [0:0] tmpINTERRUPT_0__pinRS_net;
	electrical [0:0] tmpSIOVREF__pinRS_net;

	cy_psoc3_pins_v1_10
		#(.id("ed85833b-c0c6-44a9-a01c-b141d79c1807"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		pinRS
		 (.oe(tmpOE__pinRS_net),
		  .y({Net_576}),
		  .fb({tmpFB_0__pinRS_net[0:0]}),
		  .io({tmpIO_0__pinRS_net[0:0]}),
		  .siovref(tmpSIOVREF__pinRS_net),
		  .interrupt({tmpINTERRUPT_0__pinRS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinRS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinE_net;
	wire [0:0] tmpFB_0__pinE_net;
	wire [0:0] tmpIO_0__pinE_net;
	wire [0:0] tmpINTERRUPT_0__pinE_net;
	electrical [0:0] tmpSIOVREF__pinE_net;

	cy_psoc3_pins_v1_10
		#(.id("ca335b8a-c87a-4a51-99b6-e2797cfb32d4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		pinE
		 (.oe(tmpOE__pinE_net),
		  .y({Net_577}),
		  .fb({tmpFB_0__pinE_net[0:0]}),
		  .io({tmpIO_0__pinE_net[0:0]}),
		  .siovref(tmpSIOVREF__pinE_net),
		  .interrupt({tmpINTERRUPT_0__pinE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinDB4_net;
	wire [0:0] tmpFB_0__pinDB4_net;
	wire [0:0] tmpIO_0__pinDB4_net;
	wire [0:0] tmpINTERRUPT_0__pinDB4_net;
	electrical [0:0] tmpSIOVREF__pinDB4_net;

	cy_psoc3_pins_v1_10
		#(.id("bc24083f-0c41-4b53-a70e-5d01ddd00db3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pinDB4
		 (.oe(tmpOE__pinDB4_net),
		  .y({Net_578}),
		  .fb({tmpFB_0__pinDB4_net[0:0]}),
		  .io({tmpIO_0__pinDB4_net[0:0]}),
		  .siovref(tmpSIOVREF__pinDB4_net),
		  .interrupt({tmpINTERRUPT_0__pinDB4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinDB4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinDB5_net;
	wire [0:0] tmpFB_0__pinDB5_net;
	wire [0:0] tmpIO_0__pinDB5_net;
	wire [0:0] tmpINTERRUPT_0__pinDB5_net;
	electrical [0:0] tmpSIOVREF__pinDB5_net;

	cy_psoc3_pins_v1_10
		#(.id("5c27170c-17be-4d14-be4a-928c2f060123"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pinDB5
		 (.oe(tmpOE__pinDB5_net),
		  .y({Net_579}),
		  .fb({tmpFB_0__pinDB5_net[0:0]}),
		  .io({tmpIO_0__pinDB5_net[0:0]}),
		  .siovref(tmpSIOVREF__pinDB5_net),
		  .interrupt({tmpINTERRUPT_0__pinDB5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinDB5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinDB6_net;
	wire [0:0] tmpFB_0__pinDB6_net;
	wire [0:0] tmpIO_0__pinDB6_net;
	wire [0:0] tmpINTERRUPT_0__pinDB6_net;
	electrical [0:0] tmpSIOVREF__pinDB6_net;

	cy_psoc3_pins_v1_10
		#(.id("6ab27b13-d89b-4592-a6df-205e97068f34"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pinDB6
		 (.oe(tmpOE__pinDB6_net),
		  .y({Net_580}),
		  .fb({tmpFB_0__pinDB6_net[0:0]}),
		  .io({tmpIO_0__pinDB6_net[0:0]}),
		  .siovref(tmpSIOVREF__pinDB6_net),
		  .interrupt({tmpINTERRUPT_0__pinDB6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinDB6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinDB7_net;
	wire [0:0] tmpFB_0__pinDB7_net;
	wire [0:0] tmpIO_0__pinDB7_net;
	wire [0:0] tmpINTERRUPT_0__pinDB7_net;
	electrical [0:0] tmpSIOVREF__pinDB7_net;

	cy_psoc3_pins_v1_10
		#(.id("e26d5a62-c70e-41f7-b5a6-b5a994280800"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pinDB7
		 (.oe(tmpOE__pinDB7_net),
		  .y({Net_581}),
		  .fb({tmpFB_0__pinDB7_net[0:0]}),
		  .io({tmpIO_0__pinDB7_net[0:0]}),
		  .siovref(tmpSIOVREF__pinDB7_net),
		  .interrupt({tmpINTERRUPT_0__pinDB7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinDB7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_JoyStick_net;
	wire [0:0] tmpFB_0__Pin_JoyStick_net;
	wire [0:0] tmpIO_0__Pin_JoyStick_net;
	wire [0:0] tmpINTERRUPT_0__Pin_JoyStick_net;
	electrical [0:0] tmpSIOVREF__Pin_JoyStick_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_JoyStick
		 (.oe(tmpOE__Pin_JoyStick_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_JoyStick_net[0:0]}),
		  .analog({Net_626}),
		  .io({tmpIO_0__Pin_JoyStick_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_JoyStick_net),
		  .interrupt({tmpINTERRUPT_0__Pin_JoyStick_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_JoyStick_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_SEQ_P4_v2_40_6 ADC_SAR_Seq_Button (
        .Vref(Net_716),
        .sdone(Net_717),
        .eoc(Net_718),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__pinBacklight_net;
	wire [0:0] tmpFB_0__pinBacklight_net;
	wire [0:0] tmpIO_0__pinBacklight_net;
	wire [0:0] tmpINTERRUPT_0__pinBacklight_net;
	electrical [0:0] tmpSIOVREF__pinBacklight_net;

	cy_psoc3_pins_v1_10
		#(.id("11de544a-f00a-4f99-9551-d9b295117e52"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pinBacklight
		 (.oe(tmpOE__pinBacklight_net),
		  .y({Net_697}),
		  .fb({tmpFB_0__pinBacklight_net[0:0]}),
		  .io({tmpIO_0__pinBacklight_net[0:0]}),
		  .siovref(tmpSIOVREF__pinBacklight_net),
		  .interrupt({tmpINTERRUPT_0__pinBacklight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinBacklight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
