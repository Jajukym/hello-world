...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("542456e4-4f13-416b-8e69-8982385429af"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("95e4c149-0552-477c-a05b-87a83e263d0c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 Red_1 (
        .connect({
            Net_10,
            Net_24
        })
    );
    defparam Red_1.comp_name = "LED_v1_0";
    defparam Red_1.port_names = "A, K";
    defparam Red_1.width = 2;
    ...
    cy_annotation_universal_v1_0 Red_2 (
        .connect({
            Net_12,
            Net_13
        })
    );
    defparam Red_2.comp_name = "LED_v1_0";
    defparam Red_2.port_names = "A, K";
    defparam Red_2.width = 2;
