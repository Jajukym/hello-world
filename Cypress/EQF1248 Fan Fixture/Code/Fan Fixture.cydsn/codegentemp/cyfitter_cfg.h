...
extern void adcVFan_AMux_Set(uint8 channel);
extern void adcVFan_AMux_Unset(uint8 channel);
/* adcVFan_AMux__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE adcVFan_AMux__addrTable[2];
/* adcVFan_AMux__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE adcVFan_AMux__maskTable[2];
