// ======================================================================
// Fan Fixture.v generated from TopDesign.cysch
// 05/30/2018 at 14:55
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=100, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=pwmFan, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=pwmFan, CY_INSTANCE_SHORT_NAME=pwmFan, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=pwmFan, )
module PWM_v3_30_2 (
    reset,
    clock,
    tc,
...
// RTC_v2_0(DstEnable=true, StartOfWeek=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=RTC_v2_0, CY_CONFIG_TITLE=rtcClock, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=rtcClock, CY_INSTANCE_SHORT_NAME=rtcClock, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=rtcClock, )
module RTC_v2_0_4 ;
...
module top ;
	...
	wire [0:0] tmpOE__pinVFan_net;
	wire [0:0] tmpFB_0__pinVFan_net;
	wire [0:0] tmpIO_0__pinVFan_net;
	wire [0:0] tmpINTERRUPT_0__pinVFan_net;
	electrical [0:0] tmpSIOVREF__pinVFan_net;
	...
	cy_psoc3_pins_v1_10
		...
		pinVFan
		 (.oe(tmpOE__pinVFan_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pinVFan_net[0:0]}),
		  .analog({Net_645}),
		  .io({tmpIO_0__pinVFan_net[0:0]}),
		  .siovref(tmpSIOVREF__pinVFan_net),
		  .interrupt({tmpINTERRUPT_0__pinVFan_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinVFan_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinUp_net;
	wire [0:0] tmpIO_0__pinUp_net;
	wire [0:0] tmpINTERRUPT_0__pinUp_net;
	electrical [0:0] tmpSIOVREF__pinUp_net;
	...
	cy_psoc3_pins_v1_10
		...
		pinUp
		 (.oe(tmpOE__pinUp_net),
		  .y({1'b0}),
		  .fb({Net_195[0]}),
		  .io({tmpIO_0__pinUp_net[0:0]}),
		  .siovref(tmpSIOVREF__pinUp_net),
		  .interrupt({tmpINTERRUPT_0__pinUp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinUp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinDown_net;
	wire [0:0] tmpIO_0__pinDown_net;
	wire [0:0] tmpINTERRUPT_0__pinDown_net;
	electrical [0:0] tmpSIOVREF__pinDown_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4974be50-8468-4787-bddd-2f6a3103d658"),
		  ...
		  .input_buffer_sel(2'b00))
		pinDown
		 (.oe(tmpOE__pinDown_net),
		  .y({1'b0}),
		  .fb({Net_195[1]}),
		  .io({tmpIO_0__pinDown_net[0:0]}),
		  .siovref(tmpSIOVREF__pinDown_net),
		  .interrupt({tmpINTERRUPT_0__pinDown_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinDown_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_0 pwmFan2 (
        ...
        .ph1(Net_668),
        .ph2(Net_669));
    defparam pwmFan2.Resolution = 8;

    assign Net_439 = 1'h0;

	wire [0:0] tmpOE__pinPWM2_net;
	wire [0:0] tmpFB_0__pinPWM2_net;
	wire [0:0] tmpIO_0__pinPWM2_net;
	wire [0:0] tmpINTERRUPT_0__pinPWM2_net;
	electrical [0:0] tmpSIOVREF__pinPWM2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  ...
		  .input_buffer_sel(2'b00))
		pinPWM2
		 (.oe(tmpOE__pinPWM2_net),
		  .y({Net_651}),
		  .fb({tmpFB_0__pinPWM2_net[0:0]}),
		  .io({tmpIO_0__pinPWM2_net[0:0]}),
		  .siovref(tmpSIOVREF__pinPWM2_net),
		  .interrupt({tmpINTERRUPT_0__pinPWM2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinPWM2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyStatusReg_v1_90 statusButtons (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .status_7(1'b0),
        .intr(Net_124),
        .status_bus(Net_423[3:0]));
    defparam statusButtons.Bit0Mode = 1;
    defparam statusButtons.Bit1Mode = 1;
    defparam statusButtons.Bit2Mode = 1;
    defparam statusButtons.Bit3Mode = 1;
    defparam statusButtons.Bit4Mode = 0;
    defparam statusButtons.Bit5Mode = 0;
    defparam statusButtons.Bit6Mode = 0;
    defparam statusButtons.Bit7Mode = 0;
    defparam statusButtons.BusDisplay = 1;
    defparam statusButtons.Interrupt = 1;
    defparam statusButtons.MaskValue = 15;
    defparam statusButtons.NumInputs = 4;
    ...
    defparam Debouncer_1.SignalWidth = 4;
    ...
    CharLCD_v2_20_1 lcdDisplay ();

	wire [0:0] tmpOE__pinMode_net;
	wire [0:0] tmpIO_0__pinMode_net;
	wire [0:0] tmpINTERRUPT_0__pinMode_net;
	electrical [0:0] tmpSIOVREF__pinMode_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3749fc1f-a390-4039-a6b8-d0d77e0b483b"),
		  ...
		  .input_buffer_sel(2'b00))
		pinMode
		 (.oe(tmpOE__pinMode_net),
		  .y({1'b0}),
		  .fb({Net_195[3]}),
		  .io({tmpIO_0__pinMode_net[0:0]}),
		  .siovref(tmpSIOVREF__pinMode_net),
		  .interrupt({tmpINTERRUPT_0__pinMode_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinMode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pinStart_net;
	wire [0:0] tmpIO_0__pinStart_net;
	wire [0:0] tmpINTERRUPT_0__pinStart_net;
	electrical [0:0] tmpSIOVREF__pinStart_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("666ddbba-83af-48bb-b5c1-12cf6030b5d5"),
		  ...
		  .input_buffer_sel(2'b00))
		pinStart
		 (.oe(tmpOE__pinStart_net),
		  .y({1'b0}),
		  .fb({Net_195[2]}),
		  .io({tmpIO_0__pinStart_net[0:0]}),
		  .siovref(tmpSIOVREF__pinStart_net),
		  .interrupt({tmpINTERRUPT_0__pinStart_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pinStart_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_586 = ~Net_652;

    ADC_DelSig_v3_30_3 adcVFan (
        .vplus(Net_645),
        .vminus(Net_654),
        .soc(1'b1),
        .eoc(Net_656),
