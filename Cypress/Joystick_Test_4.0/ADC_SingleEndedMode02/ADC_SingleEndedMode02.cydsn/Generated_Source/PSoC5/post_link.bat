...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\bryan.lee\Documents\PSoC Creator\ADC_SingleEndedMode02\ADC_SingleEndedMode02.cydsn\ADC_SingleEndedMode02.svd" rem "C:\Users\bryan.lee\Documents\PSoC Creator\ADC_SingleEndedMode02\ADC_SingleEndedMode02.cydsn\ADC_SingleEndedMode02.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
