...
static void ClockInit(void)
{
	...
	Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_8_BIT, 3u, 11u);
	...
	Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_8_BIT, 2u, 11u);
	Cy_SysClk_PeriphEnableDivider(CY_SYSCLK_DIV_8_BIT, 2u);
	Cy_SysClk_PeriphAssignDivider(PCLK_TCPWM1_CLOCKS3, CY_SYSCLK_DIV_8_BIT, 4u);
	Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_8_BIT, 4u, 11u);
	...
	Cy_SysClk_PeriphAssignDivider(PCLK_PASS_CLOCK_SAR, CY_SYSCLK_DIV_8_BIT, 5u);
	Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_8_BIT, 5u, 23u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_REG32(CYREG_SAR_MUX_SWITCH0, 0x00000A05u);
