// ======================================================================
// CE218133_EINK_CapSense.v generated from TopDesign.cysch
// 11/09/2019 at 23:37
...
module top ;
    ...
    TCPWM_Counter_PDL_v1_0_0 CY_EINK_Timer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
    ...
    SCB_SPI_PDL_v2_0_1 CY_EINK_SPIM (
        .interrupt(Net_97),
        .clock(1'b0),
        .rx_dma(Net_99),
        .tx_dma(Net_100),
	...
	cy_mxs40_gpio_v1_0
		#(.id("53c729f9-69c1-4597-9947-5e20908822b6"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("3c4d3e18-34dd-4016-a84e-c17ca6d6ec67"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
