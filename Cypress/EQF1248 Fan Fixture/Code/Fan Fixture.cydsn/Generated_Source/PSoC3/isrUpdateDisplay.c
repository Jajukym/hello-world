...
{
    #ifdef isrUpdateDisplay_INTERRUPT_INTERRUPT_CALLBACK
        isrUpdateDisplay_Interrupt_InterruptCallback();
    #endif /* isrUpdateDisplay_INTERRUPT_INTERRUPT_CALLBACK */
...
*
*   Note calling isrUpdateDisplay_Start or isrUpdateDisplay_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after isrUpdateDisplay_Start or isrUpdateDisplay_StartEx has been called. 
