...
#define LED_Red_0_NUM 7u
#define LED_Red_0_PORT GPIO_PRT13
...
/* LED_Orange */
#define LED_Orange_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define LED_Orange_0_INBUF_ENABLED 0u
#define LED_Orange_0_INIT_DRIVESTATE 1u
#define LED_Orange_0_INIT_MUXSEL 0u
#define LED_Orange_0_INPUT_SYNC 2u
#define LED_Orange_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define LED_Orange_0_NUM 5u
#define LED_Orange_0_PORT GPIO_PRT1
#define LED_Orange_0_SLEWRATE CY_GPIO_SLEW_FAST
#define LED_Orange_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define LED_Orange_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define LED_Orange_INBUF_ENABLED 0u
#define LED_Orange_INIT_DRIVESTATE 1u
#define LED_Orange_INIT_MUXSEL 0u
#define LED_Orange_INPUT_SYNC 2u
#define LED_Orange_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define LED_Orange_NUM 5u
#define LED_Orange_PORT GPIO_PRT1
#define LED_Orange_SLEWRATE CY_GPIO_SLEW_FAST
#define LED_Orange_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
