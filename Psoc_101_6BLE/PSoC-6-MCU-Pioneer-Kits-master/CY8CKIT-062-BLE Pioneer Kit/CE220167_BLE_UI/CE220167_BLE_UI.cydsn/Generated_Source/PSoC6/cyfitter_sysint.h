...
#define isr_gpio__INTC_CORTEXM4_PRIORITY 4u
#define isr_gpio__INTC_NUMBER 0u
#define isr_gpio_INTC_CORTEXM4_ASSIGNED 1
#define isr_gpio_INTC_CORTEXM4_PRIORITY 4u
#define isr_gpio_INTC_NUMBER 0u

/* isr_MCWDT */
#define isr_MCWDT__INTC_CORTEXM4_ASSIGNED 1
#define isr_MCWDT__INTC_CORTEXM4_PRIORITY 5u
#define isr_MCWDT__INTC_NUMBER 19u
#define isr_MCWDT_INTC_CORTEXM4_ASSIGNED 1
#define isr_MCWDT_INTC_CORTEXM4_PRIORITY 5u
#define isr_MCWDT_INTC_NUMBER 19u

/* CapSense_ISR */
#define CapSense_ISR__INTC_CORTEXM4_ASSIGNED 1
#define CapSense_ISR__INTC_CORTEXM4_PRIORITY 6u
#define CapSense_ISR__INTC_NUMBER 49u
#define CapSense_ISR_INTC_CORTEXM4_ASSIGNED 1
#define CapSense_ISR_INTC_CORTEXM4_PRIORITY 6u
