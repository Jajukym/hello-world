...
#define CYBLE_CAPSENSE_SLIDER_CHAR_INDEX   (0x00u) /* Index of Slider characteristic */
#define CYBLE_CAPSENSE_SLIDER_SLIDERCCCD_DESC_INDEX   (0x00u) /* Index of SliderCCCD descriptor */


#define CYBLE_CAPSENSE_SERVICE_HANDLE   (0x0010u) /* Handle of CapSense service */
#define CYBLE_CAPSENSE_SLIDER_DECL_HANDLE   (0x0011u) /* Handle of Slider characteristic declaration */
#define CYBLE_CAPSENSE_SLIDER_CHAR_HANDLE   (0x0012u) /* Handle of Slider characteristic */
#define CYBLE_CAPSENSE_SLIDER_SLIDERCCCD_DESC_HANDLE   (0x0013u) /* Handle of SliderCCCD descriptor */
