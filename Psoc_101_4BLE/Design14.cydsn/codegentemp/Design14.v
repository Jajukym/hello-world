// ======================================================================
// Design14.v generated from TopDesign.cysch
// 01/10/2019 at 10:12
...
module top ;
	...
	wire [0:0] tmpOE__Pin_Green_1_net;
	wire [0:0] tmpFB_0__Pin_Green_1_net;
	wire [0:0] tmpIO_0__Pin_Green_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Green_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Green_1_net;

	cy_psoc3_pins_v1_10
		#(.id("6d17af4f-6ca0-4d07-b3b1-ac69098cee7a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Green_1
		 (.oe(tmpOE__Pin_Green_1_net),
		  .y({Net_42}),
		  .fb({tmpFB_0__Pin_Green_1_net[0:0]}),
		  .io({tmpIO_0__Pin_Green_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Green_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Green_1_net[0:0]}),
		  .annotation({Net_88}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Green_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Blue_1_net;
	wire [0:0] tmpFB_0__Pin_Blue_1_net;
	wire [0:0] tmpIO_0__Pin_Blue_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Blue_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Blue_1_net;

	cy_psoc3_pins_v1_10
		#(.id("ea8c27fd-1163-4444-980d-837262fd4b0f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Blue_1
		 (.oe(tmpOE__Pin_Blue_1_net),
		  .y({Net_29}),
		  .fb({tmpFB_0__Pin_Blue_1_net[0:0]}),
		  .io({tmpIO_0__Pin_Blue_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Blue_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Blue_1_net[0:0]}),
		  .annotation({Net_89}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Blue_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Red_1_net;
	wire [0:0] tmpFB_0__Pin_Red_1_net;
	wire [0:0] tmpIO_0__Pin_Red_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Red_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Red_1_net;

	cy_psoc3_pins_v1_10
		#(.id("1699e6ff-1d5f-48f5-9105-ee9cc91d06a0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Red_1
		 (.oe(tmpOE__Pin_Red_1_net),
		  .y({Net_91}),
		  .fb({tmpFB_0__Pin_Red_1_net[0:0]}),
		  .io({tmpIO_0__Pin_Red_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Red_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Red_1_net[0:0]}),
		  .annotation({Net_90}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Red_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 Red_3 (
        .connect({
            Net_93,
            Net_1
        })
    );
    defparam Red_3.comp_name = "LED_v1_0";
    defparam Red_3.port_names = "A, K";
    defparam Red_3.width = 2;
    ...
    cy_annotation_universal_v1_0 Red_4 (
        .connect({
            Net_95,
            Net_2
        })
    );
    defparam Red_4.comp_name = "LED_v1_0";
    defparam Red_4.port_names = "A, K";
    defparam Red_4.width = 2;
    ...
    cy_annotation_universal_v1_0 Red_5 (
        .connect({
            Net_97,
            Net_3
        })
    );
    defparam Red_5.comp_name = "LED_v1_0";
    defparam Red_5.port_names = "A, K";
    defparam Red_5.width = 2;
	...
	wire [0:0] tmpOE__Pin_SW2_1_net;
	wire [0:0] tmpIO_0__Pin_SW2_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SW2_1_net;
	electrical [0:0] tmpSIOVREF__Pin_SW2_1_net;

	cy_psoc3_pins_v1_10
		#(.id("00652e95-e58e-48bb-9248-6e8bea5aeebe"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SW2_1
		 (.oe(tmpOE__Pin_SW2_1_net),
		  .y({1'b0}),
		  .fb({Net_100}),
		  .io({tmpIO_0__Pin_SW2_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SW2_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SW2_1_net[0:0]}),
		  .annotation({Net_99}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_SW2_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin
        cy_tff_1 <= Net_33^Net_29;
    end
    assign Net_29 = cy_tff_1;
    // -- TFF End --

    // -- TFF Start --
    reg  cy_tff_2;
    always @(posedge Net_29)
    begin
        cy_tff_2 <= Net_36^Net_91;
    end
    assign Net_91 = cy_tff_2;
    // -- TFF End --
    ...
    // -- TFF Start --
    reg  cy_tff_3;
    always @(posedge Net_91)
    begin
        cy_tff_3 <= Net_39^Net_42;
    end
    assign Net_42 = cy_tff_3;
    // -- TFF End --
