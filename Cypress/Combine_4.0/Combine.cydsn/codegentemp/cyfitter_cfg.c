...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000624u)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x4800064Cu)

/* IOPINS0_5 Address: CYREG_PRT5_DR Size (bytes): 10 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000654u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_DCFG0_CFG0 + 0x2u), 0x1Du);
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0 + 0x2u), 0x1Du);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT4_AG, 0xE0u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT6_AG, 0x0Du);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW0, 0x81u);
