...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x00080290u)

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x0008029Cu)

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x000802A4u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x000802B0u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x000802B8u)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x000802C0u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x000802C8u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x000Fu);
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG4_CFG0), 0x1999u);
	CY_SET_REG8((void CYXDATA *)(CYREG_CLKDIST_DCFG4_CFG0 + 0x2u), 0x1Du);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_REG8((void CYXDATA *)CYREG_BUS_SW0, 0x40u);
...
uint8 CYXDATA * const CYCODE adcVFan_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE adcVFan_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: adcVFan_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void adcVFan_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*adcVFan_AMux__addrTable[channel] |= adcVFan_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: adcVFan_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void adcVFan_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*adcVFan_AMux__addrTable[channel] &= (uint8)~adcVFan_AMux__maskTable[channel];
	}
}
